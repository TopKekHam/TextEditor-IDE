...
public delegate void PFNGLCLEARPROC(GL_Enum mask);
public delegate void PFNGLDRAWARRAYSPROC(uint mode, int first, int count);
public unsafe delegate void PFNGLDRAWELEMENTSPROC(GL_Enum mode, uint count, GL_Enum type, void* indices);
public unsafe delegate void PFNGLGENVERTEXARRAYSPROC(int n, uint* buffers);
public unsafe delegate void PFNBINDVERTEXARRAYPROC(uint array);
...
public unsafe delegate void PFNDELETEVERTEXARRAYSPROC(int n, uint* buffers);
public delegate void PFNGLBINDBUFFERPROC(GL_Enum target, uint buffer);
public unsafe delegate void PFNGLBUFFERDATAPROC(GL_Enum target, long size, void* data, GL_Enum usage);
public unsafe delegate void PFNGLVERTEXATTRIBPOINTERPROC(uint index, int size, GL_Enum type, byte normalized, int stride, void* pointer);
public delegate void PFNGLENABLEVERTEXATTRIBARRAYPROC(uint index);
public delegate uint PFNGLCREATESHADERPROC(GL_Enum type);
...
public unsafe delegate void PFNGLGETSHADERIVPROC(uint shader, GL_Enum pname, ref GL_Enum prms);
...
public delegate void PFNGLBINDTEXTUREPROC(GL_Enum target, uint texture);
public unsafe delegate void PFNGLTEXIMAGE2DPROC(GL_Enum target, int level, GL_Enum internalformat, int width, int height, int border, GL_Enum format, GL_Enum type, void* pixels);
public delegate void PFNGLTEXPARAMETERIPROC(GL_Enum target, GL_Enum pname, GL_Enum param);
public delegate void PFNGLACTIVETEXTUREPROC(GL_Enum texture);
...
public delegate void PFNGLENABLEPROC(GL_Enum cap);
public delegate void PFNGLDISABLEPROC(GL_Enum cap);
public delegate void PFNGLBLENDFUNCPROC(uint sfactor, uint dfactor);
public delegate uint PFNGLGETERRORPROC();
public unsafe delegate void PFNGLGETINTEGERV(GL_Enum pname, int* value);
public delegate void PFNGLSTENCILMASKPROC(uint mask);
public delegate void PFNGLSTENCILFUNCPROC(GL_Enum func, int _ref, uint mask);
public delegate void PFNGLSTENCILOPPROC(GL_Enum fail, GL_Enum zfail, GL_Enum zpass);
...
public unsafe static class Opengl
{
    ...
    public static PFNBINDVERTEXARRAYPROC glBindVertexArray;
    public static PFNDELETEVERTEXARRAYSPROC glDeleteVertexArrays;
    ...
    public unsafe static void SetGLAtrribs()
    {
        ...
        SDL.GL_SetAttribute(SDL_GLattr.GL_RED_SIZE, 8);
        SDL.GL_SetAttribute(SDL_GLattr.GL_GREEN_SIZE, 8);
        SDL.GL_SetAttribute(SDL_GLattr.GL_BLUE_SIZE, 8);
        SDL.GL_SetAttribute(SDL_GLattr.GL_ALPHA_SIZE, 8);

        SDL.GL_SetAttribute(SDL_GLattr.GL_DEPTH_SIZE, 16);
        SDL.GL_SetAttribute(SDL_GLattr.GL_STENCIL_SIZE, 8);

        SDL.GL_SetAttribute(SDL_GLattr.GL_DOUBLEBUFFER, 1);
    }

    public unsafe static void LoadGLProcs()
    {
        ...
        glGenVertexArrays = SDL.GL_GetProcAddress<PFNGLGENVERTEXARRAYSPROC>("glGenVertexArrays");
        glBindVertexArray = SDL.GL_GetProcAddress<PFNBINDVERTEXARRAYPROC>("glBindVertexArray");
        glDeleteVertexArrays = SDL.GL_GetProcAddress<PFNDELETEVERTEXARRAYSPROC >("glDeleteVertexArrays");

        glDebugMessageCallback(DebugOpengl, (void*)0);

        fixed (int* ptr = &MAX_TEXTURE_SIZE) { glGetIntegerv(GL_Enum.MAX_TEXTURE_SIZE, ptr); }
    }
